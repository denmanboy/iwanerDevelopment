...
@interface LeisureSportsViewController ()
...
@implementation LeisureSportsViewController
...
- (void)creatView {
    __weak LeisureSportsViewController *weakSelf = self;
    
    UILabel *selectIndustryLable = [UILabel new];
    [selectIndustryLable setText:@"请选择您的爱好主题"];
